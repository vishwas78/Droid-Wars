...
public class DataBaseClass extends SQLiteOpenHelper{
  ...
  //      db.close();
    ...
    public String[][] returnListItems() {
        ...
        Log.e("Database class", "returning from returnListItems()");
        return temp;
    }
    ...
    public TargetLayoutClass returnTargetInfo(int _id){
        ...
        tempInfo.set_house(c.getString(c.getColumnIndex(COL_HOUSE)));
    ...
    public void addNewTarget(TargetLayoutClass newTargetInfo) {
        ...
        try {
            ...
            Log.e("add new/ exception box", "error...");
        }
    }
    ...
    public String[] getNames (){
        ...
        temp = new String[n];
        SQLiteDatabase db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT " + COL_NAME + " FROM " + TABLE_HITLIST + ";", null);
        c.moveToFirst();
        int i=0;
        while(!c.isAfterLast()){
            temp[i] = c.getString(c.getColumnIndex(COL_NAME));
            c.moveToNext();
            ++i;
        }
        return temp;
